...
namespace SDC_Application.AL
{
    public partial class frmAppUpdateListMessage : Form
    {
        ...
        private void frmAppUpdateListMessage_Load(object sender, EventArgs e)
        {
            ...
            lbl1.Text = "1. " + " خسرہ میں ٹرانزیکشنل فرد جاری کرتے وقت اگر رقبہ ایک مرلہ سے کم ہوتا تو سسٹم میں رقبہ صفر اتا۔ جو کہ فیکس کر دیا گیا ہے ۔ ";
            //lbl2.Text = "2. " + " ار ایچ زی ٹاسک سے مالک کا رشتہ درست کیا جا سکتا ہے ۔ ";
            lbl1.Text = "1. " + " فرد بدر چالان تیار کرنے کی سہولت ۔ ";
            lbl2.Text = "2. " + " پشاور ڈویژن کے چالان پرو فارما پرنٹ کرنے کی سہولت ۔ ";
            lbl3.Text = "مینوال/ دستی انتقالات کی رپورٹ پرنٹ کرنے کی سہولت (ڈی آئی خان)۔  ";
        }
