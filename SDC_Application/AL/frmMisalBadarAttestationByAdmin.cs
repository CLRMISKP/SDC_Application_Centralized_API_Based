    ...
    public partial class frmMisalBadarAttestationByAdmin : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (isE_FB)
            {
                ...
                string fbid = fardbaderBL.AttestImplementFB(this.FB_Id, cboROs.Text.Trim());
                if (fbid != null)
                {
                    MessageBox.Show("Fard e Bader Successfully Attested and Implemented", "Fard e Bader", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
                }
            }
            else
