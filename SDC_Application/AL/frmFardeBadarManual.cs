...
namespace SDC_Application.AL
{
    public partial class frmFardeBadarManual : Form
    {
        ...
        private void GetHissaBeforeAfterCorrection()
        {
            ...
            if (GridViewKhewatMalikaan.DataSource != null)
            {
        ...
        private void btnSaveFardBadar_Click(object sender, EventArgs e)
        {
               try 
		           ...
		           if(dtExistingNo==null || dtExistingNo.Rows.Count==0)
                   {
        ...
        private void GridViewKhewatMalikaan_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            {
                // Here 2 cell is target value and 1 cell is Volume
                if (float.Parse(Myrow.Cells["FardAreaPart"].Value.ToString()) != float.Parse(Myrow.Cells["FardAreaPart_Proposed"].Value.ToString()))
                {
