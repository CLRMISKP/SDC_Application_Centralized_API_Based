...
namespace SDC_Application.AL
{
    public partial class frmVoucher : Form
    {
        ...
        public void Call_Proc_Get_SDC_Services_For_PaymentVoucher()
        {
            ...
            dt = this.objbusines.filldatatable_from_storedProcedure("Proc_Get_SDC_Services_For_PaymentVoucher " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + ",'" + this.txtHidenServiceTypeID.Text + "'");
            if (dt != null)
            {
        ...
        public void totalCostCalculated()
        {
            if (txtQuantity.Text.Trim() != string.Empty && txtRsPerPage.Text !=string.Empty)
            {
                if (txtServiceName.Text != "انتقال پرت فیس")
                {
                    ...
                    if (txtServiceName.Text.Contains("فرد"))
                    {
                        amount = amount + 125;
     ...
     public void  InsertioninVocherDetails()
        ...
        public void Proc_Get_SDC_Services_For_PaymentVoucher()
        {
            ...
            objauto.FillCombo("Proc_Get_SDC_Services_For_PaymentVoucher  " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + ",'" + txtHidenServiceTypeID.Text + "'", txtServiceName, "SDCServiceName_Urdu", "TaxNotificationDetailId");
