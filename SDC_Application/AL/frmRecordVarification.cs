...
namespace SDC_Application.AL
{
    public partial class frmRecordVarification : Form
    {
        ...
        private string GetServiceType()
        {
            ...
            dtToken = objDb.filldatatable_from_storedProcedure("Proc_Get_SDC_TokenService_By_TokenId " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + TokenId);
        ...
        private void FillGridviewKhattas()
        {
            try
            {
                ...
                {
                    dt = objDb.filldatatable_from_storedProcedure("Proc_Get_SDC_FardKhatasByTokenId_Verif " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + (this.TokenId != null ? this.TokenId : "0"));
                ...
                {
                    dt = objDb.filldatatable_from_storedProcedure("Proc_Get_SDC_IntiqalKhatasByTokenId " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + (this.TokenId != null ? this.TokenId : "0"));
        ...
        private void LoadKhattaIntiqalsFBs()
        {
            try
            {
                ...
                if (this.KhattaId != null && this.KhattaId != "0")
                {
                    ...
                    Intiqals = objDb.filldatatable_from_storedProcedure("proc_Get_Intiqal_List_By_KhattaId " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + this.KhattaId);
                    Fbs = objDb.filldatatable_from_storedProcedure("proc_Get_FardBader_List_By_KhattaId " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + this.KhattaId);
                    if (Intiqals != null)
                    {
        ...
        private void LoadKhattaPics(string khattaNo)
        {
            if (this.MozaId != null && this.MozaId != "0")
            {
                ...
                DataTable dt = new DataTable();
                dt = objDb.filldatatable_from_storedProcedure("Proc_Get_IndexedFiles_by_Khata " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + this.MozaId + ",'" + khattaNo + "'");
                if (ImagePathManger.ImageLocation != null)
                {
        ...
        private void listBoxlinks_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
                if (listBoxlinks.SelectedIndex >= 0)
                {
                    ...
                    DataTable dt = objDb.filldatatable_from_storedProcedure("Proc_Get_FileIndexingRecords_SDC " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + this.MozaId + ", " + docType + "," + docId);
                    if (dt != null)
                    {
                        if (ImagePathManger.ImageLocation == null)
                        {
