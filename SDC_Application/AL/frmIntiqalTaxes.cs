...
namespace SDC_Application.AL
{
    public partial class frmIntiqalTaxes : Form
    {
        ...
        private void frmIntiqalTaxes_Load(object sender, EventArgs e)
        {
            ...
            //check if payment voucher verificed then cant change intiqal taxes
            if (Intiq.ChecIntiqalPaymentVerified(this.Intiqal_Id) == "1")
            {
            ...
            toolTip1.SetToolTip(this.btnTaxReceipt, "گین ٹیکس");
        ...
        private void btnLoad_Click_1(object sender, EventArgs e)
        {
            ...
            taxNotification.LandValue = LandValue;
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (TaxRate.Trim() != string.Empty && TaxAmount.Trim() != string.Empty && float.Parse(TaxAmount) != 0 && TaxableQuantity.Trim() != string.Empty && float.Parse(TaxableQuantity) != 0)
            {
                string Query = "" + IntiqalTaxId + "," + TaxNotificationDetailId + "," + TaxRate + "," + TaxableQuantity + "," + TaxAmount.ToString() + "," + UsersManagments.UserId.ToString() + ",'" + UsersManagments.UserName.ToString() + "'";
                try
                {
            ...
            {
                MessageBox.Show("تمام ضروری معلومات درج کریں");
            }
        }
        #endregion
        ...
        public void frmIntiqalTaxReceipt_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void btnTaxReceipt_Click(object sender, EventArgs e)
        {
            frmIntiqalTaxReceipt taxReceipt = new frmIntiqalTaxReceipt();
            taxReceipt.SelectedTokenId = this.TokenId;
            taxReceipt.IntiqalId = this.Intiqal_Id;
            taxReceipt.FormClosed -= new FormClosedEventHandler(frmIntiqalTaxReceipt_FormClosed);
            taxReceipt.FormClosed += new FormClosedEventHandler(frmIntiqalTaxReceipt_FormClosed);
            taxReceipt.ShowDialog();
        }
