...
{
    public partial class frmIntiqalCancellationByRO : Form
    {
        byte[] DeSerializee; 
        ...
        public frmIntiqalCancellationByRO()
        {
            InitializeComponent();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string lastId = Intiqal.RevertIntiqal(this.intiqalId.ToString(), cboROs.SelectedValue.ToString(), txtIntiqalRevertComments.Text.Trim());
                if (lastId == "0")
                {
                    MessageBox.Show("کسی واجہ سے انتقال واپس/ریورٹ نہیں ہو سکا۔ دوبارا کوشش کریں یا ایس ڈی سی منیجر سے رابطہ کریں۔");
                    return;
                }
            ...
            {
                MessageBox.Show("تفصیل واپسی/ریورٹ انتقال میں کم از کم ۱۰ حروف لکھنا ضروری ہے۔");
            }
        }
