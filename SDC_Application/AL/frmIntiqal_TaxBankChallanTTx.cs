...
{
    public partial class frmIntiqal_TaxBankChallanTTx : Form
    {
        public frmIntiqal_TaxBankChallanTTx()
        {
            InitializeComponent();
        }
            ...
            DataSet ds = dsA;
                ...
                if (ds == null)
                {
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        ...
                        {
                            connection.Open();
                            SqlCommand command = new SqlCommand("Intiqal_TaxBankChallanTTx", connection);
                            ...
                            ds = new DataSet();
                            adapter.Fill(ds);
                            //ds.WriteXml("Intiqal_TaxBankChallanTTx", XmlWriteMode.WriteSchema);
                        }
                        catch (Exception ex)
                        {
                ...
                try
                {
                    ...
                    */
                    ...
                    cryRpt.Load(@"C:\Users\Shehzad\Documents\GitHub\SDC_Application_Centralized\SDC_Application\AL\Intiqal_TaxBankChallanTTx.rpt");                    
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ds.ReadXml("Intiqal_TaxBankChallanTTx");
            }
            catch (Exception ex)
            {
