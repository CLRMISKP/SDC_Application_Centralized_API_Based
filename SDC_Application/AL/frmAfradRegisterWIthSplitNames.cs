       ...
       ArrayList Labels = new ArrayList();
        ...
        private void SaveFard()
        {
            ...
            if (empty == null)
            {
                    ...
                    string UsrId = UsersManagments.UserId.ToString();
                    string LastId = ObjPerson.SaveInteqalAfradRegister(PersonId, PersonTypeId, FamilyId, QoamId, FamilyHead, FamilyLevel, ParentId, PersonName, Relation, FatherName, MotherName, Gender, mozaId, CNIC, DOB, Sakna, Address, FardDied, PersonCategoryId, UsrId, PersonFamilyStatus, UsersManagments.UserName.ToString(),"1");
