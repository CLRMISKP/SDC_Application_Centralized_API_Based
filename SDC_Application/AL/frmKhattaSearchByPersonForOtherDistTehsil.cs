...
{
    public partial class frmKhattaSearchByPersonForOtherDistTehsil : Form
    {
        ...
        #endregion
        public frmKhattaSearchByPersonForOtherDistTehsil()
        {
            InitializeComponent();
        }
        ...
        private void btnPopulate_Click(object sender, EventArgs e)
        {
            ...
            if ((txtVisitorName.Text.Trim().Length>2 && txtFatherName.Text.Trim().Length>2) && this.MozaID.Length>3)
            {
                this.MozaID = this.MozaID;
                ...
                this.Persons = objBusiness.filldatatable_from_storedProcedure("Proc_Self_Get_Searched_Afrad_List  " + TehsilId + "," + this.MozaID + ",1, N'" + PersonName + "',N'" + FatherName + "'");
            ...
            if ( txtCNCI.Text.Replace(txtCNCI.Text, "-").Length>10)
            {
                this.MozaID = this.MozaID;
                this.PersonName = txtVisitorName.Text.Trim();
                this.FatherName = txtFatherName.Text.Trim();
                this.Persons.Clear();
                //this.Persons = objBusiness.filldatatable_from_storedProcedure("Proc_Get_Searched_Afrad_List " + this.MozaID + ",1, N'" + PersonName + "'");
                this.Persons = objBusiness.filldatatable_from_storedProcedure("Proc_Self_Get_Searched_Afrad_List_By_CNIC  " + TehsilId + "," + this.MozaID + ",1, '" + txtCNCI.Text.Trim() + "'");
                if (this.Persons != null)
                {
                    this.FillPersonGridview(Persons);
                }
        ...
        private void GetPersonKhattas(string PersonId)
        {
            ...
            //self----------------------------------
            dtKhattas = objBusiness.filldatatable_from_storedProcedure("Proc_Self_Get_Person_KhataJats_WithLocks " + TehsilId + "," + this.MozaID + "," + PersonId);
            //---------------------------------------
            ...
            if (dtKhattas.Rows.Count > 0)
            {
              ...
              PersonTotalArea = objBusiness.filldatatable_from_storedProcedure("Proc_Self_Get_TotalRaqba_By_PersonId_MozaId " + TehsilId + "," + this.MozaID + "," + PersonId);
        ...
        private void GetPersonKhaoonies(string PID)
        {
            ...
            dtKhatoonies = objBusiness.filldatatable_from_storedProcedure("Proc_Self_Get_Person_Khatoonies " + TehsilId + "," + PID);
            ...
            if (dtKhatoonies.Rows.Count > 0)
            {
                ...
                PersonTotalAreaKK = objBusiness.filldatatable_from_storedProcedure("Proc_Self_Get_TotalRaqba_By_PersonId_MozaId_KhanaKasht " + TehsilId + "," + this.MozaID + "," + PID);
        ...
        private void grdPersonKatajats_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (grdPersonKatajats.DataSource != null)
            {
                if (rbKhatta.Checked)
                {
                    ...
                    dtKhewatFareeqainByPerson = intiqal.KhewatGroupFareeqByKhataIdPersonIdForOtherDistTehsil(this.TehsilId, grdPersonKatajats.CurrentRow.Cells["RegisterHqDKhataId"].Value.ToString(), grdPersonKatajats.CurrentRow.Cells["PersonId"].Value.ToString());
                ...
                if (rbKhatooni.Checked)
                {
                    ...
                    dtMushteriFareeqainByPerson = khatooni.MushteriFareeqByKhatooniIdPersonIdForOtherDistTehsil(this.TehsilId, grdPersonKatajats.CurrentRow.Cells["KhatooniId"].Value.ToString(), grdPersonKatajats.CurrentRow.Cells["PersonId"].Value.ToString());
            ...
            //    {
            //        if (row.Selected)
            //            row.Cells["ColSelKhata"].Value = true;
            //        else
            //            row.Cells["ColSelKhata"].Value = false;
            //    }
            //}
        }
    }
