   ...
   /// <param name="e"></param>
        ...
        private void CheckMenus()
        {
          ...
          // this.mnucreaTRoles.Visible = isMenuVisible("UserRoleDefination"); //UserRoleDefination
            ...
            this.mnuMutationCopy.Visible = isMenuVisible("frmNaqalIntiqal");
            this.TSMIIntiqalReports.Visible = isMenuVisible("TSMIIntiqalReports");
            this.mnuIntiqalTadiqDate.Visible = isMenuVisible("mnuIntiqalTadiqDate");
            this.mnuReportHaqooqMalkiatKhanakasht.Visible = isMenuVisible("mnuReportHaqooqMalkiatKhanakasht");
            this.mnuSeachPersonForAllMouzas.Visible = isMenuVisible("mnuSeachPersonForAllMouzas");
            this.mnuEnteredMutationsReport.Visible = isMenuVisible("mnuEnteredMutationsReport");
            this.mnuDePendingMutCo.Visible = isMenuVisible("mnuDePendingMutCo");
            this.mnuInitqalforDawra.Visible = isMenuVisible("mnuInitqalforDawra");
            this.mnuBayanHalfiIntiqalatNonAdmin.Visible = isMenuVisible("mnuBayanHalfiIntiqalatNonAdmin");
            this.mnuNonAdminInitqalRptBoRFormat.Visible = isMenuVisible("mnuNonAdminInitqalRptBoRFormat");
        ...
        private void mnuKhataLockUnlockDetail_Click(object sender, EventArgs e)
        {
            bool isOpen = IsFrmOpen("frmSDCReportingMain");
