...
*/
        ...
        {
            string spWithParam = "Proc_Entry_PatwarCircles " + QanoonGoiId + "";
            return ojbdb.filldatatable_from_storedProcedure(spWithParam);
        ...
        {
            string spWithParam = "proc_Get_DocumentTypes";
            return ojbdb.filldatatable_from_storedProcedure(spWithParam);
        ...
        {
            string spWithParam = "Proc_Get_IndexedFiles_by_Type" + MozaId + ", '" + DocNo + "', " + TypeId + "";
            return ojbdb.filldatatable_from_storedProcedure(spWithParam);
        ...
        {
            string spWithParam = "Proc_Get_IndexedFiles_by_Khata" + MozaId + ", '" + KhataNo + "'";
            return ojbdb.filldatatable_from_storedProcedure(spWithParam);
        ...
        {
            string spWithParam = "Proc_Get_FileIndexingRecords" + MozaId + ", " + DocumentTypeId + "";
            return ojbdb.filldatatable_from_storedProcedure(spWithParam);
        }
        ...
        {
            string spWithParam = "Proc_Get_FileIndexing_FileName" + MozaId + ", '" + DocumentType + "', '" + Recordno + "', " + Picno + "";
            return ojbdb.filldatatable_from_storedProcedure(spWithParam);
        }
        ...
        {
            string spWithParam = "Proc_Get_DocumentImage";
            return ojbdb.filldatatable_from_storedProcedure(spWithParam);
