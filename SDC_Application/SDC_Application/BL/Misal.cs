...
namespace SDC_Application.BL
{
    class Misal
    {
        ...
        {
            string retVal = "";
            string spWithParms = "WEB_SP_INSERT_FardBadar_Main_Misal " + FB_Id + "," + MozaId.ToString() + ",'" + FbDocumentNo + "','" + DateTime.Now.ToShortDateString() + "','" + GardawarDate + "','" + ConfirmationDate + "',0,'" + DateTime.Now.ToShortDateString() + "',N'" + FardBadarDetail + "'," + InsertUserId.ToString() + ",'" + InsertLoginName + "'";
        ...
        {
            string retVal="";
            string spWithParms = "WEB_SP_INSERT_FB_Khatajat " + FB_KhataId + "," + FB_ID + "," + FB_RegisterHqDKhataId + "," + RegisterHaqdaranId + ",'" + KhataNo + "',N'" + Tarf + "',N'" + Pati + "'," + TotalParts + "," + Khata_Kanal + "," + Khata_Marla + "," + Khata_Sarsai + "," + Khata_Feet + ",N'" + Malia + "',N'" + Kyfiat + "','" + DateTime.Now.ToShortDateString() + "'," + InsertUserId + ",'" + InsertLoginName + "'";
            retVal = dbobject.ExecInsertUpdateStoredProcedure(spWithParms);
            return retVal;
        }
        ...
        {
            string spWithParms = "Proc_Get_FardBadar_Main_By_DocumentNo '" + FB_DocumentNo + "'," + MozaId.ToString();
        ...
        {
            string spWithParms = "Proc_Get_FardBadar_By_Khatta " + KhataId;
            return dbobject.filldatatable_from_storedProcedure(spWithParms);
        }
        #endregion
        ...
        #region Get Fard Bader List by Moza Id
        public DataTable GetEFardBaderListByMozaId(string MozaId)
        {
            string spWithParms = "Proc_Get_FardBadar_Main_ByMozaId_EFB " + MozaId;
            return dbobject.filldatatable_from_storedProcedure(spWithParms);
        }
        #endregion
