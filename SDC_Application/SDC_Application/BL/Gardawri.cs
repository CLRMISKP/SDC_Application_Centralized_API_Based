...
namespace SDC_Application.BL
{
    class Gardawri
    {
        ...
        {
            string retVal = "0";
            string spWithParms = "WEB_SP_INSERT_Gardawari " + GardawriId + "," + MozaId + ",N'" + FasalType + "','" + DateTime.Now.ToShortDateString() + "','" + GardawriYear + "','" + KhassraId + "',N'" + KashtkaranTafseel +"',N'" + FasalDetail + "',N'" + Kayfiat + "'," + InsertUserId.ToString() + ",'" + InsertLoginName + "'";
