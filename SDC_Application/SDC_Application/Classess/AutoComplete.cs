...
namespace SDC_Application.Classess
{
    class AutoComplete
    {
        ...
        public  AutoCompleteStringCollection value(string query, string fieldname,TextBox tt)
        {
            ...
            foreach (DataRow dr in cmbdt.Rows)
            {
...
/// <summary>
        ...
        public void FillComboDist(ComboBox cmb, string DisplayMember, string ValueMember)
        {

            cmbdt = client.GetDistrictList("0");//obj.fillDataReader;
            if (cmbdt != null)
            {
                DataRow list = cmbdt.NewRow();
                list[ValueMember] = "0";
        ...
        public void FillComboTehsilByDist(ComboBox cmb, string DisplayMember, string ValueMember, string distId)
        {

            cmbdt = client.GetTehsilList(distId,"0");//obj.fillDataReader;
            if (cmbdt != null)
            {
                DataRow list = cmbdt.NewRow();
                list[ValueMember] = "0";
