    ...
    public partial class frmInteqalWitness : Form
    {
        ...
        public void FillIntiqalWitnessGrid()
        {
            ...
            if (dt != null)
            {
                ...
                GridWitnessDetails.Columns["Gender"].DisplayIndex = 2;
                GridWitnessDetails.Columns["cnic"].DisplayIndex = 3;
                GridWitnessDetails.Columns["Relation"].DisplayIndex = 4;
                GridWitnessDetails.Columns["Address"].DisplayIndex = 5;
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (txtWitnessFatherName.Text.Trim() != string.Empty && txtWittnessPersonName.Text.Trim() != string.Empty && txtWitnessCNIC.Text.Trim() != string.Empty)
            {
                ...
                string LastId = pers.SaveInteqalWitness(WitnessId, IntiqalId, WitnessPersonId, usrId, UsrName, usrId, UsrName, PersonId, PersonName, FatherName, CNIC, Gender, MozaId, Adress);
        ...
        {
            DataTable dt = this.objbusines.filldatatable_from_storedProcedure("Proc_Get_PersonDetail_By_NIC '" + this.txtWitnessCNIC.Text + "'");
            if (dt != null)
            {
