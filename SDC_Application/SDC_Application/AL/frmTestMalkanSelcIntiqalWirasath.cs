    ...
    public partial class frmTestMalkanSelcIntiqalWirasath : Form
    {
        ...
        private void SaveKhewatGroupFreqein()
        {
            foreach (DataGridViewRow row in GridViewMalikanSelect.Rows)
            {
                ...
                string s = intiq.SaveintiqalBuyers(IntiqalBuyerRecId, IntiqalKhataRecId, KhatoniRecid, IntiqalBuyerPersonId, Buyer_Hissa, Buyer_Kanal, Buyer_Marla, Buyer_Sarsai, Buyer_Feet, KhewatTypeId,"0");
            }
