...
namespace SDC_Application.AL
{
    public partial class frmMalkiatHistoryDetails : Form
    {
        ...
        private void frmIntiqalAmalDaramadByKhata_Load(object sender, EventArgs e)
        {
            ...
            objauto.FillCombo("Proc_Get_Moza_List "+UsersManagments._Tehsilid.ToString(), cmbMouzaKhanakasht, "MozaNameUrdu", "MozaId");
        }
        ...
        #region Fill Grid view method
         ...
         {
             objauto.FillCombo("Proc_Get_KhatooniNos_List_By_KhataId "+cboKhataKhanakasht.SelectedValue.ToString(), cmbKhatooniNo, "KhatooniNo", "KhatooniId");
         }
         ...
         private void cmbKhatooniNo_SelectionChangeCommitted(object sender, EventArgs e)
         {
            ...
            if(dtAllMushteriFareeqain!=null)
