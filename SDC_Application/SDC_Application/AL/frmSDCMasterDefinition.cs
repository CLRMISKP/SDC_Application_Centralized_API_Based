    ...
    public partial class frmSDCMasterDefinition : Form
    {
        ...
        private void frmSDCMasterDefinition_Load(object sender, EventArgs e)
        {
           ...
           //-----------------------------------------
            ...
            FillServicesGrid();
            objauto.FillCombo("Proc_Get_ServiceTypes_All", cboServiceType, "ServiceTypeName_Urdu", "ServiceTypeId");
            ...
            objauto.FillCombo("Proc_Get_SDC_Services_List", cboNotSrvName, "SDCServiceName_Urdu", "SDCServiceId");
            objauto.FillCombo("Proc_Get_ServiceTypes_All", cboNotSrvType, "ServiceTypeName_Urdu", "ServiceTypeId");
            objauto.FillCombo("Proc_Get_SDC_ServiceCostUnits_List", cboNotSrvCostUnit, "SDCUnitName_Urdu", "SDCUnitId");
        }
        #endregion
