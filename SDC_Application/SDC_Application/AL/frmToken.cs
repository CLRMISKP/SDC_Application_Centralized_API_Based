    ...
    public partial class frmToken : Form
    {
       ...
       private void txtVisitorName_KeyPress_1(object sender, KeyPressEventArgs e)
       {
        ...
        public void WEB_SP_INSERT_SDC_Tokens(string username, string UserID, string tokenverified, TextBox tokenid, TextBox tokenno, TextBox status,string TokenDuplicate)
        {
                                    ...
                                    "WEB_SP_INSERT_SDC_Tokens '" + tokenid.Text.ToString() + "',"+UsersManagments._Tehsilid+",'"
                                    + datetoken + "','" 
        ...
        {
            dt = this.objbusines.filldatatable_from_storedProcedure("Proc_Get_SDC_Token_Detail_By_NIC '"+this.txtCNCI.Text.Trim()+"'");
            if (dt != null)
            {
