...
namespace SDC_Application.AL
{
    public partial class frmKhattaLocking : Form
    {
        ...
        private void GetKhattasByMoza(string MozaId)
        {
            ...
            dtKhattas = objBusiness.filldatatable_from_storedProcedure("Proc_Get_Moza_Register_KhataJat_SDC_For_Locking " + MozaId + ",0");
        ...
        {
            DataTable dtKhattas = new DataTable();
            dtKhattas = objBusiness.filldatatable_from_storedProcedure("Proc_Get_Moza_Register_KhataJat_SDC_For_Locking_By_Search " + MozaId + ",0,'"+KhataNo+"'");
            this.grdPersonKatajats.DataSource = dtKhattas;
            if (dtKhattas!=null)
            {
                grdPersonKatajats.Columns["KhataNo"].HeaderText = "کھاتہ نمبر";
        ...
        {
            MalikanKatajat.setKhataLock(txtKhewatKhataId.Text, cbLockKhata.Checked.ToString(), txtVisitorName.Text, cbLockKhataShowToDE.Checked.ToString(), "0");
