...
namespace SDC_Application.AL
{
    public partial class frmRecipt : Form
    {
        ...
        {
            objauto.FillCombo("Proc_Get_SDC_PaymentTypes_List", cmbPaymentofSource, "PaymentType_Urdu", "PaymentTypeId");
       ...
       private void frmSearch_Click(object sender, EventArgs e)
        ...
        {
            string RecieptNo="0";
            DataTable dtReciept = objbusines.filldatatable_from_storedProcedure("Proc_Get_SDC_ReceiptVoucherNo_By_TokenId " + TokenId);
            if (dtReciept != null)
            {
        ...
        public void Proc_Get_SDC_PaymentVoucherDetail_BY_VoucerId()
         {
                                objauto.FillCombo("Proc_Get_SDC_PaymentVoucherDetail_BY_VoucerId '"
        ...
        private void cmbServices_SelectedIndexChanged(object sender, EventArgs e)
        {
            //this.txtAmountRecieve.Location = new System.Drawing.Point(621, 70);
            //this.lbl2.Location = new System.Drawing.Point(637, 30);
            //MessageBox.Show(cmbServices.SelectedValue.ToString());
            ...
            else
            {
                ...
                dt = objbusines.filldatatable_from_storedProcedure("Proc_Get_SDC_PaymentVoucherDetail_BY_VoucerId_For_Recipt '" + this.txtHiddenPvid.Text + "','" + this.cmbServices.SelectedValue.ToString() + "'");
                foreach (DataRow dr in dt.Rows)
                {
                ...
                //txtBankName.Text = "";
                //txtChalanFormNum.Text = "";
              //  MessageBox.Show(txtRvsequence.Text.ToString() + this.txtRVDetailid.Text.ToString());
        ...
        public void call_Details_Recipt_Grd()
        {
            try
            {
                dtGrd = objbusines.filldatatable_from_storedProcedure("Proc_Get_SDC_ReceiptVoucherDetail_By_RVId '" + this.txtRIV.Text + "'");
        ...
        private void chkVerfiedReciptMaster_Click(object sender, EventArgs e)
        {
            if (txtTotPaymentRecived.Text != "" & txtNetAmountToPay.Text != "" && txtRIV.Text != "")
            {
                try
                {
                    ...
                    {
                        dt = objbusines.filldatatable_from_storedProcedure("WEB_SP_UPDATE_SDC_ReceiptVoucherMaster '" + txtRIV.Text + "','" + chkVerfiedReciptMaster.Checked + "',''");
        ...
        private void chkVerfiedReciptMaster_CheckedChanged(object sender, EventArgs e)
        {
