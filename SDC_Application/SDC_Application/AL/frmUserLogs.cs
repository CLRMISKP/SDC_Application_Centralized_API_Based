...
namespace SDC_Application.AL
{
    public partial class frmUserLogs : Form
    {
        ...
        {
            auto.FillCombo("Proc_Get_Moza_List " + UsersManagments._Tehsilid.ToString(), cmbMouza, "MozaNameUrdu", "MozaId");
        }
        ...
        {
            auto.FillCombo("proc_Get_Moza_KhataJat_for_Intiqal "+cmbMouza.SelectedValue.ToString(), cmbKhataNo, "KhataNo", "RegisterHqDKhataId");
        }
