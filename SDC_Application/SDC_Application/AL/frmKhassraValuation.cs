...
namespace SDC_Application.AL
{
    public partial class frmKhassraValuation : Form
    {
        ...
        private void frmKhassraValuation_Load(object sender, EventArgs e)
        {
            ...
            objauto.FillCombo("Proc_Get_Intiqal_PlotTypes_List", cboKhassraType, "PlotType_Urdu", "PlotTypeId");
            objauto.FillCombo("Proc_Get_Intiqal_PlotTypes_List", cboAreaType, "PlotType_Urdu", "PlotTypeId");
        }
        ...
        private void cmbMouza_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            objauto.FillCombo("Proc_Get_Moza_Khassra_List " + cmbMouza.SelectedValue.ToString(), cboKhassraList, "KhassraNo", "KhassraId");
        }
        ...
        {
            objauto.FillCombo("Proc_Get_KhassraArea_Deatil " + cboKhassraList.SelectedValue.ToString(), cboKhassraDetailList, "AreaType", "KhassraDetailId");
        }
