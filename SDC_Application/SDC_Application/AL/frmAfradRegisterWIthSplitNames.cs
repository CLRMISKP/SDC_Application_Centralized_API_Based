...
{
    public partial class frmAfradRegisterWIthSplitNames : Form
    {
        ...
        public frmAfradRegisterWIthSplitNames()
        {
            InitializeComponent();
        }
       ...
       ArrayList Labels = new ArrayList();
            ...
            if (empty == null)
            {
                    ...
                    string LastId = ObjPerson.SaveInteqalAfradRegister(PersonId, PersonTypeId, FamilyId, QoamId, FamilyHead, FamilyLevel, ParentId, PersonName, Relation, FatherName, MotherName, Gender, mozaId, CNIC, DOB, Sakna, Address, PersonDied, PersonCategoryId, UsrId, PersonFamilyStatus);
        ...
        private void fillFardMoza()
        {
            try
    			{
            this.dtMoza = ObjPerson.GetMozaList(UsersManagments._Tehsilid.ToString());
        ...
        private void SaveFard()
        {
            ...
            if (empty == null)
            {
                    ...
                    string UsrId = UsersManagments.UserId.ToString();
                    string LastId = ObjPerson.SaveInteqalAfradRegister(PersonId, PersonTypeId, FamilyId, QoamId, FamilyHead, FamilyLevel, ParentId, PersonName, Relation, FatherName, MotherName, Gender, mozaId, CNIC, DOB, Sakna, Address, FardDied, PersonCategoryId, UsrId, PersonFamilyStatus);
        ...
        struct NodeData {
            public bool Parent; public int PersonId; public int FamilyID; public String PersonName;public int ParentId; public int FamilyNo;
            public NodeData(bool cParent, int cPersonId, int cFamilyID ,String  sPersonName ,int cParentId,int cFamilyNo)
            { 
        ...
        private void btrnFardSearch_Click(object sender, EventArgs e)
        {
            ...
            dtAfradRegister.AsEnumerable()
               ...
               // .Select(datarow => new { key = datarow.Field<int>("FamilyId"), val = datarow.Field<string>("PersonName") })
                .Select(datarow => new NodeData(true, datarow.Field<int>("PersonId"), datarow.Field<int>("FamilyId"), datarow.Field<String>("PersonName"), datarow.Field<int>("ParentId"),datarow.Field<int>("FamilyNo")))
                ...
                {//bool Parent; int PersonId;int FamilyID; String PersonName
                    ...
                    dtAfradRegister.AsEnumerable()
                                    .Where(Row1 => Row1.Field<int>("PersonFamilyStatusId") == 2 && Row1.Field<int>("MozaId") == iMozaId && Row1.Field<int>("FamilyId") == x.Key &&  (searchi == "" || Row1.Field<string>("PersonName").Replace(" ","").Replace(" ", "").Contains(searchi)))
                                    ...
                                    .Select(datarow1 => new NodeData(false, datarow1.Field<int>("PersonId"), datarow1.Field<int>("FamilyId"), datarow1.Field<String>("PersonName"), datarow1.Field<int>("ParentId"), datarow1.Field<int>("FamilyNo"))) 
                                    ...
                                    .ToList().TrueForAll(y =>
                                    {
                                        ...
                                        nc.Tag = y.Value;
                                        try{n.Nodes.Add(nc);}catch (Exception) { }
                                        NoFardFound = false;
                                        return true;
