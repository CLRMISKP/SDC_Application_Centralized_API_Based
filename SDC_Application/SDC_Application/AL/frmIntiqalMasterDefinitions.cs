...
namespace SDC_Application.AL
{
    public partial class frmIntiqalMasterDefinitions : Form
    {
        ...
        public string TehsilId = UsersManagments._Tehsilid.ToString(); //{ get; set; }
        ...
        private void frmIntiqalMasterDefinitions_Load(object sender, EventArgs e)
        {
          ...
          //  TehsilId = (UsersManagments._Tehsilid != null && UsersManagments._Tehsilid > 0) ? UsersManagments._Tehsilid.ToString() : "NULL";
            ...
            auto.FillCombo("Proc_Get_Intiqal_TypeCategory_List", cmbIntiqalTypeCat, "IntaIntiqalTypeCategory", "IntiqalTypeCategoryId");
            auto.FillCombo("Proc_Get_Intiqal_PlotTypes_List", txtUrduPlot, "PlotType_Urdu", "PlotTypeId");
            auto.FillCombo("Proc_Get_SDC_PaymentTypes_List", cboPaymentType, "PaymentType_Urdu", "PaymentTypeId");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtTaxNameEng.Text.Trim() != "" && txtTaxNameUrdu.Text.Trim() != "")
                {
                    ...
                    string s = MasDef.SaveIntiqalTaxesList(TaxeId, TehsilId, TaxCategoryId, TaxName_Urdu, Taxname_English, UserId, UserName, UserId, UserName);
                    FillGridByTaxlist();
        ...
        {
            DataTable dt = new DataTable();
            dt = tax.GetIntiqalTaxNotification(UsersManagments._Tehsilid.ToString());
