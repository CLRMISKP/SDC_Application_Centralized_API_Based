...
namespace SDC_Application.BL
{
    class MasterDefinition
    {
        ...
        {
            string spWithParam = "Proc_Get_SDC_TokenPurpose_List  " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() ;
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

        public DataTable GetSDCPaymentTypesList()
        {
            string spWithParam = "Proc_Get_SDC_PaymentTypes_List " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() ;
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

        public DataTable GetSDCServiceTypesList()
        {
            string spWithParam = "Proc_Get_SDC_ServiceTypes_List  " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() ;
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

        public DataTable GetSDCServiceCostUnitsList()
        {
            string spWithParam = "Proc_Get_SDC_ServiceCostUnits_List " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() ;
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

        public DataTable GetSDCServicesList()
        {
            string spWithParam = "Proc_Get_SDC_Services_List " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() ;
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

        public DataTable GetSDCServiceCostNotificationsList()
        {
            string spWithParam = "Proc_Get_SDC_ServiceCostNotifications_List  " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString();
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

        public DataTable GetIntiqalTypesList()
        {
            string spWithParam = "Proc_Get_IntiqalTypes_List " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() ;
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

        public DataTable WEB_SP_DELETE_DocmentID(string DocId)   
        {
            string spWithParam = "WEB_SP_DELETE_Intiqal_DucomentsList  " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + ",'" + DocId + "'";
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

    public DataTable WEB_SP_DELETE_IntiqalType(string IntiqalTypeID)
        {
            string spWithParam = "WEB_SP_DELETE_IntiqalType  " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + IntiqalTypeID + "";
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

     public DataTable GetIntiqalDocumentsList()  
        {
            string spWithParam = "Proc_Get_Intiqal_DocumentsList_List " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString();
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

     public DataTable DELETEPlotConstructionType(string PlotConstructionTypeId) 
        {
            string spWithParam = "WEB_SP_DELETE_Intiqal_PlotConstructionType " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + ", " + PlotConstructionTypeId + "";
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

        public DataTable GetIntiqalPlotConstructionTypesList() 
        {
            string spWithParam = "Proc_Get_Intiqal_PlotConstructionTypes_List " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() ;
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }
        ...
        {
            string spWithParam = "Proc_Get_Intiqal_TaxCategories_List " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() ;
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }

        public DataTable DELETE_PlotType(string IntiqalTypeId)  
        {
            string spWithParam = "WEB_SP_DELETE_PlotType  " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + IntiqalTypeId + "";
            return dbobject.filldatatable_from_storedProcedure(spWithParam);
        }
        #endregion
        ...
        {
            string spWithParam = "WEB_SP_INSERT_Intiqal_TaxNotificationDetail  " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + TaxNotificationDetailId + "," + TaxNotificationId + "," + SeqNo + "," + TaxId + "," + PaymentTypeId + "," + SDCUnitId + ",'" + TaxRateType + "','" + TaxRate + "',N'" + TaxDetailNotfRemarks + "'," + InsertUserId + ",'" + InsertLoginName + "'";
            return dbobject.ExecInsertUpdateStoredProcedure(spWithParam);
        }
