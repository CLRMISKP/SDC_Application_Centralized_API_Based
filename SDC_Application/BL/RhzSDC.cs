...
namespace SDC_Application.BL
{
    class RhzSDC
    {
       ...
       // Proc_Get_Gaintax
        ...
        {
            string spWithParam = "WEB_SP_INSERT_KhewatGroupFareeqeinWithRecStatus " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + ",'" + KhewatGroupFareeqId + "'," + RegisterHaqkhataid + "," + PersonId + ",'" + FardAreaPart + "'," + fardkanal + "," + fardmarla + "," + fardsarsai + "," + fardfeet + "," + KhewatTypeId + "," + RegisterHaqkhataid + "," + InsertUserId + ",'" + InsertLoginName + "','" + FardPart_Bata + "','" + TransactionType + "'," + RecStatus;
            return dbobject.ExecInsertUpdateStoredProcedure(spWithParam);
        }
        ...
        {
            string spWithParam = "WEB_SP_INSERT_KhewatGroupFareeqeinEdit " + KhewatGroupFareeqRecId + "," + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + ",'" + KhewatGroupFareeqId + "'," + RegisterHaqkhataid + "," + PersonId + "," + PersonIdProp + ",'" + FardAreaPart + "','" + FardAreaPartProp + "'," + fardkanal + "," + fardkanalProp + "," + fardmarla + "," + fardmarlaProp + "," + fardsarsai + "," + fardsarsaiProp + "," + fardfeet + "," + fardfeetProp + "," + KhewatTypeId + "," + KhewatTypeIdProp + "," + RegisterHaqkhataid + "," + InsertUserId + ",'" + InsertLoginName + "','" + FardPart_Bata + "','" + FardPart_BataProp +"','" + TransactionType + "'," + SeqNo+","+RHZ_ChangeId+",'"+EditMode+"'";
            return dbobject.ExecInsertUpdateStoredProcedure(spWithParam);
        }
