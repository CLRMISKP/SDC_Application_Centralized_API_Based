...
namespace SDC_Application.BL
{
    class DocumentApproval
    {
        ...
        {
            string spWithParams = "Proc_Get_SDC_DocumentsApprovalStatus " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() ;
        ...
        {
            string spWithParams = "WEB_SP_UPDATE_SDC_TokenStatus  " + SDC_Application.Classess.UsersManagments._Tehsilid.ToString() + "," + TokenId + ",N'" + Token_CurrentStatus + "',N'" + Token_CurrentStatus_Reason + "'";
